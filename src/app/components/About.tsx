          ...
          >
            <div className="bg-white/5 backdrop-blur-md rounded-2xl p-8 border border-white/10">
              <p className="text-gray-300 text-lg leading-relaxed mb-6">
                Passionate MCA student with expertise in Full Stack Development,
                Cloud Computing, and DevOps. Skilled in building scalable web
                applications and deploying cloud-native solutions using AWS,
                Docker, Kubernetes, Terraform, Jenkins, and ArgoCD.
                Experienced in implementing CI/CD pipelines, infrastructure
                automation, and modern software development practices while
                exploring AI-powered technologies to solve real-world
                challenges.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <motion.div
                  ...
                  whileHover={{ x: 5 }}
                >
                  <Cloud className="text-green-400 w-5 h-5 flex-shrink-0" />
            ...
            >
              ...
              <p className="text-gray-300">
                To build impactful software solutions as a Full Stack and DevOps
                Engineer, leveraging AWS cloud services, Kubernetes, Terraform,
                CI/CD pipelines, and modern development technologies to create
